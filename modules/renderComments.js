...
import { initCommentClick, initLike, initAddComment } from './initListeners.js'
import { sanitizeHtml, formatDate } from './helpers.js'
import { token, currentUserName } from './api.js'
...
export const renderComments = () => {
        ...
        return `
            <li class="comment" data-index="${index}">
                ...
                <div class="comment-body">
                    <div class="comment-text">${escapedCommentText}</div>
                </div>
    ...
    const formOrLink = token ? `
        <div class="add-form">
            ...
            <input type="text" class="add-form-name" placeholder="Введите ваше имя" value="${currentUserName}" readonly />
    ...
    ` : `
        <div style="text-align: center; padding: 20px;">
            <p>Чтобы добавить комментарий, <a href="#" id="auth-link">авторизуйтесь</a></p>
        </div>
    `
